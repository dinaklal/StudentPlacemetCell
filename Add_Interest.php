 ...
 <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="background-image:url('images/1.jpg') ;background-repeat: no-repeat; background-position: center;background-size: cover;">
            <center>  <b> <h1  style="color:green;font-weight: 10000; text-shadow: 2px 2px green;">Add Inetrests</h1></b></center>
        ...
        <select class="form-control" class="form-control" name="student" required >
...
while($row=mysqli_fetch_array($res))
          ...
          <div class="form-group">
            <span class="label label-primary">Intrerest 1 </span>
